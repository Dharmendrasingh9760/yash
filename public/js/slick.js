...
$(".custom-select").each(function() {
    ...
    template += '<em class="custom-select-trigger">' + $(this).attr("placeholder") + '</em>';
    template += '<div class="custom-options">';
    $(this).find("option").each(function() {
        template += '<em class="custom-option ' + $(this).attr("class") + '" data-value="' + $(this).attr("value") + '">' + $(this).html() + '</em>';
    });
    template += '</div></div>';
