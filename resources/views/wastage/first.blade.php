...
@section('content')
    <div class="xl:px-[4rem] px-[20px] py-[3rem]">
        <div class="flex items-center gap-4">
            <h2 class=" font-bold text-[32px] leading-[40px] text-[#000000]">Wastage Collection</h2>
            <img src="{{ asset('admin-assets/images/propertyImg.png') }}">
        </div>
        <div class=" lg:flex gap-6">
            <a href="{{ route('wastage.index') }}" id="tradeLicense" class="mt-5 cursor-pointer ">
                <div class="lg:w-[262px] w-full mt-10 px-[20px] py-[30px] box-shadow rounded-[20px]">
                    ...
                    <p class="font-semibold text-[22px] leading-[32px] text-[#202224]">Apply for Wastage<br>
                        Collection → </p>
                </div>
            </a>
            <a href="{{ route('wastageList') }}" class="mt-5 cursor-pointer">
                <div class="lg:w-[262px] w-full  mt-10 px-[20px] py-[30px] box-shadow rounded-[20px]">
                    <div>
    ...
    <div id="successModal"
        ...
        <div
            ...
            <h5 class=" font-semibold text-[22px] lg:text-[28px] text-center  leading-[40px] pt-10">Wastage Collection Submitted Successfully</h5>
        </div>
    </div>
    <script>
        function openModal() {
