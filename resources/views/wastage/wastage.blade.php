...
@section('content')
    ...
    <div class="xl:px-[4rem] px-[20px] py-[3rem]">
        <h2 class=" font-bold text-[24px] leading-[30px] lg:text-[32px] lg:leading-[40px] text-[#000000]">Wastage Collection
        </h2>
        <div>
            <form action="{{ route('wastageStore') }}" method="post" id="myForm">
                @csrf
                <div class="border border-[#B1B6C6] rounded-[20px] mt-10 pb-[20px]">
                    ...
                    <div
                        ...
                        <div>
                            <div class="font-normal text-[15px] leading-[30px] text-[#000000] pb-[10px]">12 Digit Code</div>
                            <input type="number" name="12_code" value="{{ old('12_code') }}"
                                class="uppercase w-full border border-[#B1B6C6] pl-[19px] rounded-[100px] h-[60px]"
                                autocomplete="off">
                            <span class="" style="color:red">{{ $errors->first('12_code') }}</span>
                        </div>
