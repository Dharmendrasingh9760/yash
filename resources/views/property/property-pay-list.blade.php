...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <div class="xl:px-[4rem] md:px-[20px] px-[10px] py-[3rem]">
        <div class="lg:flex lg:items-center justify-between gap-4 flex flex-col md:flex md:flex-row">
            <h2 class=" font-bold text-[31px] lg:text-[32px] leading-[40px] text-[#000000]">Property Tax</h2>
            <a id="addnewproperty" href="{{ route('property.pay.add') }}"
        ...
        <div class="border border-[#B1B6C6] rounded-[20px]  ">
            ...
            <form id="myForm" action="{{ route('property.pay.list') }}" method="POST"
                ...
                <div class="flex items-center gap-5">
                    <div onclick="closedList()">
                        ...
                        <!-- <img src="{{ asset('admin-assets/images/print.png') }}" /> -->
                            <a href="{{route('property.pay.list')}}"><img src="{{ asset('admin-assets/images/cross.png') }}" /> </a>
                    </div>
    ...
    <script>
     ...
     <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function handleButtonClick(activeButton, inactiveButton, value) {
            ...
            nonResidentialBtn.addEventListener('click', () => {
                handleButtonClick(nonResidentialBtn, residentialBtn, 'Non Residential');
            });

            residentialBtn.addEventListener('click', () => {
                handleButtonClick(residentialBtn, nonResidentialBtn, 'Residential');
            });
        });
    </script>
