...
@section('content')
    <div class="xl:px-[4rem] px-[20px] py-[3rem]">
        <div class="flex items-center gap-4">
            <h2 class=" font-bold text-[32px] leading-[40px] text-[#000000]">Property Tax Asset</h2>
            <img src="{{ asset('admin-assets/images/propertyImg.png') }}" />
        </div>
        <div class=" lg:flex gap-6">
            <a href="{{ /* route('property.pay.list') */ route('property.pay.add') }}" class="cursor-pointer">
                <div class="lg:w-[262px]  w-full mt-10 px-[20px] py-[30px] box-shadow rounded-[20px]">
                    ...
                    <div class="mt-5 ">
                        <p class="font-semibold text-[22px] leading-[32px] text-[#202224]">Pay Property <br>
                            Tax→</p>
                    </div>
                </div>
            </a>
            <a href="{{ route('my.property.application.list') }}" class="cursor-pointer">
                <div class="lg:w-[262px] w-full  mt-10 px-[20px] py-[30px] box-shadow rounded-[20px]">
                    <div>
        ...
        <div class="mt-10">
            <div class="faq-item bg-[#FFF5EC] rounded-[15px] py-[20px] px-[30px]">
                ...
                <div class="faq-answer mt-2 hidden">
                    <p class=" font-medium text-[16px] leading-[28px] text-[#000000]">To manage your property tax, start by
                        using the search option to check if your property has already been submitted. If it has, simply
                        search for it using the provided tool. If you have a new property to register, fill out and submit
                        the required form. Once you submit the form for a new property, its status will be marked as
                        pending. An administrator will then review your submission. The administrator may either approve or
                        reject your submission. If it is rejected, you will be provided with reasons for the rejection. If
                        it is approved, you will be notified to proceed with the payment. After completing the payment, you
                        will be able to download your property tax certificate from the website. This process ensures that
                        all property tax submissions are reviewed thoroughly and processed efficiently. </p>
                </div>
            </div>
