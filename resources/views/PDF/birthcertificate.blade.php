...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <p>(Issued under Section 12/17 of the Registration of Births and Deaths Act, 1969 and Rule 8/13 of the
                Rajasthan Registration of Births and Deaths Rules, 2000)</p>
            <p>Form - A</p>
            <p>(See Rule-4)</p>
        </div>
        <div class="content">
            <p>This is to certify that the following information has been taken from the original record of birth which
                is the register for (local area/local body) ................................ of Tehsil/Block
            ...
            <div class="section">
                <p>Address of parents at the time of birth of the Child:
            ...
            <div class="section">
                ...
                <p>Name of the village or town where the mother resides:
        ...
        <div class="footer">
            <p>Note: Information in respect of the columns "Present address of parents at the time of birth of the
                child" and "Permanent address of parents" were not applicable before 01/01/2007</p>
            <p>Use of Digital Signature for issuing birth and death certificate is recognized by Economics and
                Statistics Department, Government of Rajasthan vide circular number F13/1/39/VS/DES/2013/22519 Dated
                02.06.2015.</p>
