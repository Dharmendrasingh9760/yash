            ...
            <div class="">
                <div class="home-builder-page-title">
                    ...
                    <ol class="flex mt-10">
                        ...
                        <li class="active text-[#f0ca00] pl-[10px]"> सन्देश</li>
                    </ol>
                </div>
            ...
            <table id="table-body" class=" min-w-full  ">
                <thead class=" border-b-2 border-[#000000] ">
                    <tr>
                        ...
                        <th class="px-4 py-4 whitespace-nowrap font-semibold  text-[15px] leading-[22px]">अपलोड की तिथि</th>
                ...
                <tbody class="">
                    <tr class="border-b border-[#212529]">
                        ...
                        <td class="px-4 py-4 text-center whitespace-nowrap font-medium text-[15px] leading-[22px]">this is
                            sanndesh for everyone</td>
