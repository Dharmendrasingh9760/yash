...
<div class="xl:px-[4rem] px-[20px] py-[3rem]">
    ...
    <a href="{{route('birth.certificate.add')}}" id="tradeLicense"  class="cursor-pointer ">
    <div class="lg:w-[262px]  w-full mt-10 px-[20px] py-[30px] box-shadow rounded-[20px]">
        <div class="flex items-center gap-5">
            ...
            <p class="font-semibold text-[22px] leading-[32px] text-[#202224] mt-5">Apply for Birth<br>
            Certificate→ </p>


    </div>
    </a>
    <a href="{{route('birth.certificate.list')}}" class="  cursor-pointer">
    <div class="lg:w-[262px] w-full  mt-10 px-[20px] py-[30px] box-shadow rounded-[20px]">
        <div>
...
<div class="mt-10">
    <div class="faq-item bg-[#FFF5EC] rounded-[15px] py-[20px] px-[30px]">
        ...
        <div class="faq-answer mt-2 hidden">
            <p class=" font-medium text-[16px] leading-[28px] text-[#000000]">To apply for a birth certificate, begin by accessing the necessary application form on our website. Fill in all the required information accurately and submit the form. Once submitted, your request will be marked as pending. An administrator will review your request, and you will be notified whether it is approved or rejected, with reasons provided in the case of a rejection. If your request is approved, you will need to proceed with the payment. After completing the payment, you can download your birth certificate from the websites. </p>
        </div>
    </div>
...
<div id="successModal" class="fixed inset-0 z-50 top-[-32px] flex items-center justify-center bg-black bg-opacity-50  px-[10px] hidden">
    <div  class=" lg:w-[770px] w-full bg-[#FFFFFF] rounded-[20px] px-[10px] lg:px-[40px] pb-[40px] mt-[30px] md:max-h-full lg:max-h-full max-h-[400px] overflow-scroll">
        ...
        <h5 class=" font-semibold text-[22px] lg:text-[28px] text-center  leading-[40px] pt-10">Birth Certificate Application Submitted Successfully</h5>
        <p class=" font-normal text-[20px] leading-[28px] text-center mt-5 px-[20px] text-[#B9B9B9]">Admin will review your form, and if approved, then your payment will be required and Payment prices mention below.</p>
