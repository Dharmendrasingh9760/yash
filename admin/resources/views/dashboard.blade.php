...
@section('content')
    <div class=" xl:pl-[4rem] px-[20px] py-[1rem]">
        ...
        <div class=" xl:grid lg:grid lg:grid-cols-3 xl:grid-cols-5 md:grid md:grid-cols-2 gap-5">
            ...
            <a href="{{route('property.store')}}">
            <div class="w-full mt-10 px-[20px] py-[30px] box-shadow rounded-[20px] cursor-pointer">
                <div>
                    <img src="{{ asset('admin-assets//images/contact.png') }}">
                </div>
                    <p class="font-semibold text-[22px] leading-[32px] text-[#202224] pt-5">Collect <br>
                        Tax→</p>
            </div>
            </a>
            ...
            <a href="{{ route('propertyCount') }}">
                <div class="w-full mt-10 px-[20px] py-[30px] box-shadow rounded-[20px] cursor-pointer">
                    <div>
                        <img src="{{ asset('admin-assets//images/contact.png') }}">
                    </div>
                    <p class="font-semibold text-[22px] leading-[32px] text-[#202224] mt-5">How Many People Apply→</p>
                </div>
            </a>
