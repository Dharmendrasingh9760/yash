        ...
        <div class="flex flex-col gap-[10px] border-b px-[20px] border-[#B1B6C6]  overflow-hidden pb-[40px] ">
            ...
            <!-- <div class="">
                <a href="{{ route('wards.index') }}"
                    class="{{ request()->routeIs(['wards.index', 'wards.create', 'wards.edit']) ? 'active' : '' }} flex items-center p-2 text-base text-gray-900 transition duration-75  w-[260px] h-[50px] rounded-[10px]   hover:bg-[#FFE4CD] "
                    aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                    <img src="{{ asset('admin-assets//images/buildings.png') }}" class="pl-[10px]">
                    <span
                        class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap font-semibold text-[15px] leading-[18px] text-[#000000]">Ward</span>
                </a>
            </div>  -->
        ...
        <div class="flex flex-col gap-10px px-[24px] py-[10px] ">
            ...
            <div class="">
                <a href="{{ route('webSetting') }}"
                    class="{{ request()->routeIs(['webSetting']) ? 'active' : '' }} flex items-center p-2 text-base text-gray-900 transition duration-75  w-[260px] h-[50px] rounded-[10px]   hover:bg-[#FFE4CD] "
                    aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                    <img src="{{ asset('admin-assets//images/setting.png') }}" class="pl-[10px]">
                    <span
                        class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap font-semibold text-[15px] leading-[18px] text-[#000000]">Website Setting</span>
