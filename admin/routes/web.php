...
Route::get('/captcha-refresh', [UserController::class, 'refreshCaptcha'])->name('captcha');
...
Route::get('/', [UserController::class, 'loginForm'])->name('login.page');
...
Route::group(['middleware' => ['check.status', 'auth']], function () {
    ...
    Route::get('property/add', [PropertyController::class, 'store'])->name('property.store');
    Route::any('property-cash-add', [PropertyController::class, 'propertycashsave'])->name('propertycashsave');

    Route::get('property_count', [PropertyController::class, 'propertyCount'])->name('propertyCount');
    Route::get('property-import', [PropertyController::class, 'PropertyImport'])->name('PropertyImport');
    Route::post('property-import-save', [PropertyController::class, 'PropertyImportStore'])->name('PropertyImportStore');
    Route::any('property-export/{id?}', [PropertyController::class, 'PropertyExport'])->name('PropertyExport');
    ...
    Route::get('property/notification/{id}', [PropertyController::class, 'propertyNotification'])->name('propertyNotification');
    Route::post('upload-property-pay-slip', [PropertyController::class, 'UploadPropertyTaxSlip'])->name('upload.property.pay.slip');
    Route::get('property-downlaod/{id?}', [PropertyController::class, 'downloadPdf'])->name('downloadPdf');
...
Route::prefix('ward')->name('wards.')->group(function () {
    Route::get('/', [App\Http\Controllers\WardController::class, 'index'])->name('index');
    Route::get('create', [App\Http\Controllers\WardController::class, 'create'])->name('create');
    Route::post('store', [App\Http\Controllers\WardController::class, 'store'])->name('store');
    Route::get('edit/{id}', [App\Http\Controllers\WardController::class, 'edit'])->name('edit');
    Route::post('update/{id}', [App\Http\Controllers\WardController::class, 'update'])->name('update');
    Route::get('delete/{id}', [App\Http\Controllers\WardController::class, 'delete'])->name('delete');
    Route::delete('change-status/{id}/{status}', [App\Http\Controllers\WardController::class, 'changeStatus'])->name('changeStatus');
});
    ...
    Route::post('change-password-profile', [UserController::class, 'profileChangePassword'])->name('profileChangePassword');
    ...
    //website setting
    Route::get('website-setting', [WebsiteController::class, 'websetting'])->name('webSetting');
