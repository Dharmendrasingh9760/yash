...
class CreatePropertiesPermissionTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('properties_permission', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('properties_permission');
    }
}
